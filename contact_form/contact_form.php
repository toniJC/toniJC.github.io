...
// configure
$from = 'contacto@antoniojunquera.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'antoniojunquerac@gmail.com'; // Replace it with Your email. REQUIRED!
$subject = 'Nuevo correo desde la web CV';
...
$okMessage = 'Muchas gracias! En breve recibirá respuesta.';
$errorMessage = 'Parece que se ha producido un error en el envío, inténtelo de nuevo más tarde';
